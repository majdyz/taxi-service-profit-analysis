...
\begin{figure}[H]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_02.jpg}
		\captionof{figure}{Visualisasi Bulan Kedua$\\KL Divergence = 0.015632698168624958$}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_03.jpg}
...
\begin{figure}[H]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_04.jpg}
		\captionof{figure}{Visualisasi Bulan Keempat$\\KL Divergence = 0.03152148657242697$}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_05.jpg}
...
\begin{figure}[H]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_06.jpg}
		\captionof{figure}{Visualisasi Bulan Keenam$\\KL Divergence = 0.036093264517592136$}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_07.jpg}
...
\begin{figure}[H]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_08.jpg}
		\captionof{figure}{Visualisasi Bulan Kedelapan$\\KL Divergence = 0.039705311189136054$}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_09.jpg}
...
\begin{figure}[H]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_10.jpg}
		\captionof{figure}{Visualisasi Bulan Kesepuluh$\\KL Divergence = 0.026295761592674213$}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Line/Line_Anomaly_11.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{Line/Line_Anomaly_12.jpg}
...
\begin{figure}[H]
	...
	\begin{minipage}{.4\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Month_09_CropMarked.jpg}
		\captionof{figure}{Plot Frekuensi Penggunaan Taksi Bulan Kesembilan}
	\end{minipage}%
	\hspace{.1\textwidth}
	\begin{minipage}{.4\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Month_10_CropMarked.jpg}
...
\begin{figure}[H]
	...
	\begin{minipage}{.4\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Month_11_CropMarked.jpg}
		\captionof{figure}{Plot Frekuensi Penggunaan Taksi Bulan Kesebelas}
	\end{minipage}%
	\hspace{.1\textwidth}
	\begin{minipage}{.4\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{Month_12_CropMarked.jpg}
